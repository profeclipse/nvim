return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>ne", "<cmd>Noice errors<cr>", { desc = "Show error messages in a split" })
    vim.keymap.set("n", "<leader>nf", "<cmd>Noice fzf<cr>", { desc = "Open mesage history in fzf" })
  end,
}
